...
public class LedgerEntryController {
    ...
    public LedgerEntrySearchPageResponse searchEntries(
            ...
            @RequestParam(required = false) Long categoryDetailId,
            @RequestParam(defaultValue = "false") boolean paymentMethodOther,
            @RequestParam(defaultValue = "false") boolean categoryGroupOther,
