...
| Group | Variables |
| --- | --- |
| Database and migrations | `DB_URL`, `DB_DRIVER`, `DB_SERVER`, `DB_ID`, `DB_PASS`, `JPA_SHOW_SQL`, `JPA_FORMAT_SQL`, `H2_CONSOLE_ENABLED`, `DB_MIGRATION_ENABLED`, `DB_MIGRATION_BASELINE_ON_MIGRATE`, `DB_MIGRATION_BASELINE_VERSION`, `DB_MIGRATION_VALIDATE_ON_MIGRATE` |
