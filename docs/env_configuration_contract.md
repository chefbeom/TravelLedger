...
| Group | Variables |
| --- | --- |
| Database and migrations | `DB_URL`, `DB_HOST`, `DB_PORT`, `DB_NAME`, `DB_DRIVER`, `DB_SERVER`, `DB_ID`, `DB_USER`, `DB_PASS`, `DB_PASSWORD`, `JPA_SHOW_SQL`, `JPA_FORMAT_SQL`, `H2_CONSOLE_ENABLED`, `DB_MIGRATION_ENABLED`, `DB_MIGRATION_BASELINE_ON_MIGRATE`, `DB_MIGRATION_BASELINE_VERSION`, `DB_MIGRATION_VALIDATE_ON_MIGRATE`, `JPA_DEFAULT_BATCH_FETCH_SIZE`, `APP_SCHEMA_LEGACY_UPDATERS_ENABLED` |
| Object storage and presigned URLs | `MINIO_API`, `MINIO_API_INTERNAL_URL`, `MINIO_PUBLIC_API`, `MINIO_NAME`, `MINIO_ACCESS_KEY`, `MINIO_SECRET`, `MINIO_SECRET_KEY`, `MINIO_CLOUD_BUCKET`, `MINIO_BUCKET`, `MINIO_WORKSPACE_BUCKET`, `MINIO_PRESIGNED_URL_EXPIRY_SECONDS`, `MINIO_STORAGE_CAPACITY_BYTES` |
| Auth/session and seed | `JWT_KEY`, `JWT_EXPIRE`, `SESSION_SEAL_KEY`, `OPS_CONTROL_SEAL_KEY`, `PUBLIC_MEDIA_KEY`, `SESSION_COOKIE_SECURE`, `REMEMBER_ME_SECURE_COOKIE`, `CSRF_COOKIE_SECURE`, `APP_SEED_ENABLED`, `APP_SEED_ALLOW_INSECURE_DEFAULT_CREDENTIALS` |
...
| Recurring household ledger | `APP_LEDGER_RECURRING_ENABLED`, `APP_LEDGER_RECURRING_CRON`, `APP_LEDGER_RECURRING_ZONE` |
| Ledger AI provider | `APP_LEDGER_AI_ENABLED`, `APP_LEDGER_AI_PROVIDER`, `APP_LEDGER_AI_WORKFLOW_URL`, `APP_LEDGER_AI_API_KEY`, `APP_LEDGER_AI_API_KEY_HEADER`, `APP_LEDGER_AI_MODEL`, `APP_LEDGER_AI_LMSTUDIO_BASE_URL`, `APP_LEDGER_AI_LMSTUDIO_CHAT_PATH`, `APP_LEDGER_AI_LMSTUDIO_MODELS_PATH`, `APP_LEDGER_AI_LMSTUDIO_API_KEY`, `APP_LEDGER_AI_OPENAI_BASE_URL`, `APP_LEDGER_AI_OPENAI_CHAT_PATH`, `APP_LEDGER_AI_OPENAI_MODELS_PATH`, `APP_LEDGER_AI_OPENAI_API_KEY`, `APP_LEDGER_AI_TEMPERATURE`, `APP_LEDGER_AI_MAX_TOKENS`, `APP_LEDGER_AI_CONNECT_TIMEOUT`, `APP_LEDGER_AI_READ_TIMEOUT`, `APP_LEDGER_AI_ENFORCE_PROVIDER_URL_ALLOWLIST`, `APP_LEDGER_AI_ALLOWED_PROVIDER_HOSTS`, `APP_LEDGER_AI_HISTORY_RETENTION_ENABLED`, `APP_LEDGER_AI_HISTORY_RETENTION_DAYS`, `APP_LEDGER_AI_HISTORY_RETENTION_CRON`, `APP_LEDGER_AI_HISTORY_RETENTION_ZONE` |
| Redis state and cache | `REDIS_CACHE_HOST`, `REDIS_CACHE_PORT`, `REDIS_CACHE_PASSWORD`, `REDIS_CACHE_USERNAME`, `REDIS_CACHE_KEY_PREFIX`, `REDIS_CACHE_DATABASE`, `REDIS_CACHE_SSL`, `REDIS_STATE_HOST`, `REDIS_STATE_PORT`, `REDIS_STATE_PASSWORD`, `REDIS_STATE_USERNAME`, `REDIS_STATE_KEY_PREFIX`, `REDIS_STATE_DATABASE`, `REDIS_STATE_SSL` |
| Family/support and data ops | `FAMILY_MEDIA_STORAGE_PATH`, `FAMILY_MEDIA_OBJECT_PREFIX`, `SUPPORT_ATTACHMENT_STORAGE_PATH`, `DATA_OPS_BACKUP_EXECUTION_MODE`, `DATA_OPS_BACKUP_AGENT_URL`, `DATA_OPS_BACKUP_AGENT_TOKEN`, `DATA_OPS_BACKUP_AGENT_CONNECT_TIMEOUT`, `DATA_OPS_BACKUP_AGENT_READ_TIMEOUT`, `DATA_OPS_BACKUP_WORKDIR`, `DATA_OPS_BACKUP_REMOTE_NAME`, `DATA_OPS_BACKUP_REMOTE_DIR`, `DATA_OPS_MINIO_BACKUP_REMOTE_DIR`, `DATA_OPS_ARCHIVE_REMOTE_DIR`, `DATA_OPS_PROJECT_KEY`, `DATA_OPS_SECONDARY_BACKUP_ENABLED`, `DATA_OPS_SECONDARY_BACKUP_DIR`, `DATA_OPS_RCLONE_CONFIG_PATH`, `DATA_OPS_BACKUP_ZONE`, `DATA_OPS_DB_BACKUP_ENABLED`, `DATA_OPS_DB_BACKUP_CRON`, `DATA_OPS_MINIO_BACKUP_ENABLED`, `DATA_OPS_MINIO_BACKUP_CRON` |
