...
$requiredGroups = [ordered]@{
    'database-and-migrations' = @(
        'DB_URL', 'DB_DRIVER', 'DB_SERVER', 'DB_ID', 'DB_USER', 'DB_PASS', 'DB_PASSWORD',
    ...
    'object-storage-and-presigned-url' = @(
        'MINIO_API', 'MINIO_API_INTERNAL_URL', 'MINIO_PUBLIC_API', 'MINIO_NAME', 'MINIO_ACCESS_KEY', 'MINIO_SECRET', 'MINIO_SECRET_KEY', 'MINIO_BUCKET',
    ...
    'redis-state-and-cache' = @(
        'REDIS_CACHE_HOST', 'REDIS_CACHE_PORT', 'REDIS_CACHE_PASSWORD', 'REDIS_CACHE_USERNAME', 'REDIS_CACHE_KEY_PREFIX',
        'REDIS_CACHE_DATABASE', 'REDIS_CACHE_SSL', 'REDIS_STATE_HOST',
        'REDIS_STATE_PORT', 'REDIS_STATE_PASSWORD', 'REDIS_STATE_USERNAME', 'REDIS_STATE_KEY_PREFIX', 'REDIS_STATE_DATABASE', 'REDIS_STATE_SSL'
    )
    'family-support-and-data-ops' = @(
        'FAMILY_MEDIA_STORAGE_PATH', 'FAMILY_MEDIA_OBJECT_PREFIX',
        'SUPPORT_ATTACHMENT_STORAGE_PATH', 'DATA_OPS_BACKUP_EXECUTION_MODE', 'DATA_OPS_BACKUP_AGENT_URL', 'DATA_OPS_BACKUP_AGENT_TOKEN', 'DATA_OPS_BACKUP_AGENT_CONNECT_TIMEOUT', 'DATA_OPS_BACKUP_AGENT_READ_TIMEOUT', 'DATA_OPS_BACKUP_WORKDIR',
        'DATA_OPS_BACKUP_REMOTE_NAME', 'DATA_OPS_BACKUP_REMOTE_DIR',
        'DATA_OPS_MINIO_BACKUP_REMOTE_DIR', 'DATA_OPS_ARCHIVE_REMOTE_DIR', 'DATA_OPS_PROJECT_KEY', 'DATA_OPS_SECONDARY_BACKUP_ENABLED', 'DATA_OPS_SECONDARY_BACKUP_DIR', 'DATA_OPS_RCLONE_CONFIG_PATH',
...
$allowedExtraPatterns = @(
    ...
    '^DATA_OPS_SECONDARY_BACKUP_HOST_PATH$',
